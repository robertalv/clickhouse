...
export function validateClickHouseTableName(table) {
...
export function quoteClickHouseTableName(table) {
...
export function validatePositiveInteger(name, value, max) {
...
export function validateReadOnlyClickHouseQuery(sql) {
...
function throwInvalidTableName(table) {
    throw new ConvexError({
        code: "INVALID_TABLE_NAME",
        message: `Invalid ClickHouse table name "${table}". ` +
